...
# Zmienna środowiskowa z tokenem
...
# URL do loga serwera
SERVER_LOGO_URL = "https://i.imgur.com/NJZ5Fzj.png"  # Podmień na swoje logo!
...
async def on_ready():
    ...
    for channel_id, offer_text in OFFERS.items():
        ...
        button_url = f"https://discord.com/channels/{ticket_channel.guild.id}/{ticket_channel.id}" if ticket_channel else "https://discord.com"

        view = View()
        view.add_item(Button(label="Utwórz ticket", style=discord.ButtonStyle.link, url=button_url))
